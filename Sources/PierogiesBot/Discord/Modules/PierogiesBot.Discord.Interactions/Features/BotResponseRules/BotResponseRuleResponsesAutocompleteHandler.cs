...
public class BotResponseRuleResponsesAutocompleteHandler : AutocompleteHandler
{
    private readonly IBotResponseRuleFacade _facade;

    public BotResponseRuleResponsesAutocompleteHandler(IBotResponseRuleFacade facade)
    {
        _facade = facade;
    }
